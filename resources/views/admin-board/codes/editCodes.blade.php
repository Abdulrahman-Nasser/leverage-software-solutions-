...
@section('title', 'Admin | Edit Codes')
                    ...
                    <div class="card-body">
                        ...
                        <nav class="d-none d-md-block" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Code</li>
                            </ol>
                        </nav>
                        <!-- End Breadcrumb -->

                        <div class="mb-3 mb-md-4 d-flex justify-content-between">
                            <div class="h3 mb-0">Edit Code</div>
                        </div>
                        ...
                        <!-- Form -->
                        <div>
                            <form action="{{ route('admin.editCodes' , $codes->id) }}" method="POST">
                                @csrf
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-6">
                                        <label for="name">Instructor Name</label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            value="{{ $codes->name }}" id="name" name="name" placeholder="name">
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('code') is-invalid @enderror"
                                            value="{{ $codes->code }}" id="code" name="code" placeholder="Code">
                                    </div>
