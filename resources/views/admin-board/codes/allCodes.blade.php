                    ...
                    <div class="card-body">
                        ...
                        <nav class="d-none d-md-block" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">All Codes</li>
                            </ol>
                        </nav>
                        <!-- End Breadcrumb -->

                        <div class="mb-3 mb-md-4 d-flex justify-content-between">
                            <div class="h3 mb-0">Codes</div>
                        </div>
                                ...
                                <tbody>
                                    @forelse ($codes as $data)
                                        <tr>
                                            ...
                                            <td class="py-3">{{ $data->code }}</td>
                                            <td class="py-3">{{ $data->created_at }}</td>

                                            <td class="py-3">
                                                <div class="position-relative">
                                                    <a class="link-dark d-inline-block"
                                                        href="{{ route('admin.getEditCodes', $data->id) }}">
                                                        <i class="gd-pencil icon-text"></i>
                                                    </a>
                                                    <a class="link-dark d-inline-block"
                                                        href="{{ route('admin.destroyCodes', $data->id) }}">
                                    ...
                                    @empty
                                        <div class="empty text-center bg-transparent border-1 text-danger  p-3 m-3"
                                            style="color: white;">No Codes has been Generated</div>
                                    @endforelse
