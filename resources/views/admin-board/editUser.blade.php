            ...
            <div class="py-4 px-3 px-md-4">
                <div class="card mb-3 mb-md-4">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form -->
                        <div>
                            <form action="{{ route('admin.edit-user', $users->id) }}" method="POST">
                                @csrf
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-6">
                                        <label for="name">Name</label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            value="{{ $users->name }}" id="name" name="name" placeholder="name">
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            value="{{ $users->email }}" id="email" name="email" placeholder="email">
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-12 col-md-12">
                                        ...
                                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                                            value="{{ $users->password }}" id="password" name="password" placeholder="password">
                                    </div>
